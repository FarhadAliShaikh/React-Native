...
export default function App() {
  ...
  // state variables for (password, passwordGenerated, lowercase, uppercase, numbers, symbols)
  ...
  const passwordGenerated = (passwordLength: number) => {
    ...
    if(numbers) charactersList += digits;
    if(symbols) charactersList += specialChars;

    const passwordCreate = createPassword(charactersList, passwordLength);
      ...
      <SafeAreaView style = {styles.appContainer}>
        <View style = {styles.formContainer}>
          ...
          <Formik
            ...
            onSubmit={ values => {
              console.log(values);
              passwordGenerated(Number(values.passwordLength));
            }} 
          >
            {({
               values,
